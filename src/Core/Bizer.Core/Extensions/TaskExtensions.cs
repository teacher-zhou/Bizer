...
public static class TaskExtensions
{
    ...
    public static ValueTask<TResult> AsValueTask<TResult>(this TResult result) => new(result);
    ...
    /// <returns></returns>
    public static Task AsTask(this CancellationToken cancellationToken) => Task.FromCanceled(cancellationToken);
}
